...
<!--
🔒 PROTECTED FILE - DO NOT MODIFY DIRECTLY
====================================================
...
Version: 1.0.0 (Perfect Resume Templates)
Source: src/data/resumeData.ts via scripts/generate_resume_html.ts

⚠️  WARNING: This file is AUTOMATICALLY GENERATED
    Manual modifications will be OVERWRITTEN
    Changes must be made via TypeScript generator only
    Unauthorized edits are STRICTLY PROHIBITED
...
🎯  Status: PRODUCTION READY - PROTECTED BASELINE
====================================================
-->
<html lang="en">
<head>
    ...
    <script type="module">
        ...
        function handlePrint() {
            ...
            try {
                ...
                // Show browser-specific instructions for PDF generation
                if (isEdge || isFirefox) {
                    const browserName = isEdge ? 'Edge' : 'Firefox';
                    const instructions = isEdge 
                        ? 'In the print dialog, change "Printer" to "Microsoft Print to PDF" or "Save as PDF"'
                        : 'In the print dialog, change "Destination" to "Save to PDF"';
                    ...
                    // Chrome and other browsers - direct print
                    window.print();
                }
